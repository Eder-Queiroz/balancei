...
final colorPickerViewModelProvider =
    AutoDisposeNotifierProvider<ColorPickerViewModel, BasePickerModelState>(
  ColorPickerViewModel.new,
);

class ColorPickerViewModel extends BasePickerViewModel {
  ...
  Future<void> fetchAvailableItems({
    ...
    final result = await _pickerRepository.getAvailableColors();
    state = result.fold(
      (success) {
